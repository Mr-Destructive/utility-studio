...
<svg 
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <style type="text/css">{`.st0{fill:#a128c3;}`}</style>
      <g>
        <path
          className="st0"
